...
/// <summary>
/// Singleton read-only master data database loaded at startup from JSON files.
/// Contains all EntityM* tables (quests, weapons, costumes, gacha, missions, etc.)
/// that define game content and rules. Shared across all user sessions.
/// </summary>
